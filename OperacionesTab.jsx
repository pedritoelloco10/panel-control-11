...
export default function OperacionesTab({ draft, identity }) {
  ...
  async function removePublicidad() {
    ...
    if (pubErr) {
      ...
      // ok === false: no había ningún mensaje propio para borrar en este turno — no hacer nada, no es un error.
  ...
  return (
    <div className="pt-5">
      ...
      <div className="sticky top-16 z-10 mb-2.5 space-y-1.5 backdrop-blur">
        <div className="bg-white/[0.03] ring-1 ring-white/5 rounded-2xl p-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-slate-500 text-[11px] truncate">
                {pubError ? "No se pudo actualizar — probá de nuevo" : pubHoy === null ? "Cargando..." : `Este turno: ${pubHoy} mensaje${pubHoy !== 1 ? "s" : ""}`}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white/[0.03] ring-1 ring-white/5 rounded-2xl p-2.5">
